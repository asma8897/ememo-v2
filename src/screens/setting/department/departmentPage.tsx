import {
  ...
  } from "../../../features/api/departmentApi";
import { setId } from "../../../features/slices/departmentSlice";
...
import LoadingButton from '@mui/lab/LoadingButton';
  ...
  export function DepartmentPage() {
    ...
    const { data, isLoading, isError } = useGetAllDepartmentQuery();
    const [addNewDepartment] = useAddNewDepartmentMutation();
    ...
    const ceateNewDepartmentForm =  async (data: any) => {
      let payload = {
        name: data.name,
    ...
    const confirmDeleteHandler = () => {
      deleteDepartment(itemIdToDelete)
        .then(() => {
          setOpenDelete(false);
          setItemIdToDelete(0);
        });
